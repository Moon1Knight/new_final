      ...
      <div className="space-y-4 sm:space-y-6">
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base">+91 7997043355 , +91 7997043366</p>
        ...
        <div className="flex items-start">
          ...
          <div>
            ...
            <p className="text-gray-600 text-sm sm:text-base">Monday - Saturday : 8:00 AM - 5:00 PM</p>
