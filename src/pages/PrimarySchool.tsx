    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100">
      ...
      <div className="container mx-auto px-4 py-12 max-w-[75rem]">
        ...
        <motion.h1 
          ...
          className="text-3xl md:text-4xl font-bold text-gray-800 mb-8 text-center bg-gradient-to-r from-purple-600 to-purple-800 bg-clip-text text-transparent drop-shadow-sm"
        >
          Primary School
        </motion.h1>
        ...
        <motion.div
          ...
          className="mb-16 relative w-full max-w-4xl mx-auto rounded-2xl overflow-hidden shadow-lg"
        >
          <img
        ...
        >
          <p className="text-gray-700 leading-relaxed mb-6 text-justify first-letter:text-5xl first-letter:font-bold first-letter:text-purple-600 first-letter:float-left first-letter:mr-2 first-letter:mt-1">
          ...
          <p className="text-gray-700 leading-relaxed mb-6 text-justify indent-8">
        ...
        <motion.div 
          ...
          className="mb-16 bg-white rounded-2xl p-8 md:p-9 shadow-lg border border-gray-100"
        >
          <h2 className="text-purple-600 text-2xl font-semibold mb-6 underline decoration-purple-300 decoration-2 underline-offset-4">
            Curriculum for Primary Level (Class I-V)
          </h2>
          <p className="text-gray-700 leading-relaxed mb-6 text-justify first-letter:text-4xl first-letter:font-semibold first-letter:text-purple-500 first-letter:float-left first-letter:mr-2">
          ...
          <div className="space-y-6">
            <div className="border-l-4 border-purple-200 pl-6">
              <h3 className="text-gray-800 text-xl font-medium mb-3 underline decoration-gray-300 decoration-1 underline-offset-2">Language Education</h3>
            ...
            <div className="border-l-4 border-purple-200 pl-6">
              <h3 className="text-gray-800 text-xl font-medium mb-3 underline decoration-gray-300 decoration-1 underline-offset-2">Mathematics</h3>
              <p className="text-gray-700 leading-relaxed text-justify">
            ...
            <div className="border-l-4 border-purple-200 pl-6">
              <h3 className="text-gray-800 text-xl font-medium mb-3 underline decoration-gray-300 decoration-1 underline-offset-2">Environmental Studies & Science</h3>
              <p className="text-gray-700 leading-relaxed text-justify">
            ...
            <div className="border-l-4 border-purple-200 pl-6">
              <h3 className="text-gray-800 text-xl font-medium mb-3 underline decoration-gray-300 decoration-1 underline-offset-2">Technology & Arts</h3>
              <p className="text-gray-700 leading-relaxed text-justify">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed text-justify first-letter:text-4xl first-letter:font-semibold first-letter:text-purple-500 first-letter:float-left first-letter:mr-2">
